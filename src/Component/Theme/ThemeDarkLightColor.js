...
class MyThemeClass {
  ...
  getThemeColor = () => {
    return {
      ...
      TXTDARKGREY: this.mode === 'dark' ? '#505050' : '#dcdde1',
      ...
      CHECKOUTTHEMECOLOR: this.mode === 'dark' ? '#c23616' : "#eb2f06",
      ...
      HEADINGTEXTCOLOR: this.mode === 'dark' ? Colors.babyblue : Colors.cerulean,
      GRADIENTHEADER1COLOR: this.mode === 'dark' ? "#000000" : Colors.azure,
      GRADIENTHEADER2COLOR: this.mode === 'dark' ? "#0F52BA" : Colors.babyblue,
      ORANGETHEMECOLOR: this.mode === 'dark' ? "#e84118" : "#F79F1F",
      ORANGEREDTHEMECOLOR: this.mode === 'dark' ? "#b33939" : "#e84118",
    }
